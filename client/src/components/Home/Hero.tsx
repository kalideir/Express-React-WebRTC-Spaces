        ...
        <div className="container mx-auto flex flex-col items-center py-12 sm:py-24">
          <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col  mb-5 sm:mb-10">
            ...
            <p className="mt-5 sm:mt-10 lg:w-10/12 text-slate-400 font-normal text-center text-sm sm:text-lg">
              Twitter-Space or Clubhouse-like platform for audio-based discussions. Create, share and participant in various spaces. Built using
              Peer2Peer and Socket.io.
            </p>
          </div>
