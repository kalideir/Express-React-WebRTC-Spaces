              ...
              <div className="my-20 flex items-center justify-center">
                <div className="flex justify-end px-5 pt-5 relative">
                  <button
                    ...
                    type="button"
                    className="text-white bg-red-400 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    End Space
                  </button>
